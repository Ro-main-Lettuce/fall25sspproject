...
@@ -40,15 +33,19 @@ class AnthropicBatchRequestProcessor(BaseBatchRequestProcessor):
     """"""
...
@@ -78,9 +75,7 @@ def max_concurrent_batch_operations(self) -> int:
         """"""
         return 100
...
@@ -109,9 +104,7 @@ def parse_api_specific_request_counts(
...
@@ -217,9 +210,7 @@ def parse_api_specific_response(
...
+            logger.warning(f""custom_id {raw_response['custom_id']} result was '{result_type}' with error '{error}'"")
             ...
             token_usage = None
@@ -230,18 +221,16 @@ def parse_api_specific_response(
...
@@ -263,8 +252,7 @@ def parse_api_specific_response(
         )
...
@@ -278,9 +266,7 @@ async def submit_batch(self, requests: list[dict], metadata: dict) -> GenericBat
         """"""
...
@@ -299,10 +285,7 @@ async def retrieve_batch(self, batch: GenericBatch) -> GenericBatch:
             try:
...
@@ -323,7 +306,7 @@ async def download_batch(self, batch: GenericBatch) -> list[dict] | None:
