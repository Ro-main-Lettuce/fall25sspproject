@@ -146,7 +146,6 @@ def test_when_read_then_add_cursor_field(self, http_mocker: HttpMocker) -> None:
         )
...
-
     ...
     @HttpMocker()
@@ -213,7 +212,7 @@ def test_given_no_state_when_read_then_use_external_accounts_endpoint(self, http
...
@@ -222,12 +221,7 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
+            _events_request().with_created_gte(state_datetime).with_created_lte(_NOW).with_limit(100).with_types(_EVENT_TYPES).build(),
             ...
             .build(),
@@ -240,7 +234,7 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
@@ -263,12 +257,7 @@ def test_given_object_is_not_back_account_when_read_then_filter_out(self, http_m
...
@@ -277,7 +266,7 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
         http_mocker.get(
             _events_request()
...
+            .with_created_gte(state_datetime)
             ...
             .with_limit(100)
             .with_types(_EVENT_TYPES)
@@ -296,24 +285,19 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
