...
+    def test_get_device_code(self, mock_post) -> None:
         ...
         mock_response.json.return_value = {
             ""device_code"": ""123456"",
@@ -23,16 +24,14 @@ def test_get_device_code(self, mock_post):
...
+    def test_display_auth_instructions(self, mock_open, mock_print) -> None:
         device_code_data = {
             ...
             ""user_code"": ""ABCDEF"",
@@ -49,8 +48,8 @@ def test_display_auth_instructions(self, mock_open, mock_print):
...
+    ) -> None:
         ...
         mock_response.json.return_value = {
@@ -66,12 +65,12 @@ def test_poll_for_token_success(
...
+    def test_poll_for_token_error(self, mock_print, mock_post) -> None:
         ...
         mock_response.json.return_value = {
@@ -80,14 +79,14 @@ def test_poll_for_token_error(self, mock_print, mock_post):
         }
...
+    def test_poll_for_token_timeout(self, mock_print, mock_post) -> None:
         ...
         mock_response.status_code = 400
         mock_response.json.return_value = {
@@ -99,5 +98,5 @@ def test_poll_for_token_timeout(self, mock_print, mock_post):
