...
@@ -24,11 +21,11 @@ def test_getattr_delegates_to_stream(self):
...
@@ -38,11 +35,11 @@ def test_getattr_raises_attributeerror_for_missing_attributes(self):
...
@@ -57,11 +54,11 @@ def test_getattr_delegates_to_stream(self):
         mock_stream.model = ""gpt-4""
...
+
         ...
         assert wrapper.model == mock_stream.model
         assert wrapper.id == mock_stream.id
@@ -71,26 +68,23 @@ def test_getattr_raises_attributeerror_for_missing_attributes(self):
         """"""Test that __getattr__ raises AttributeError for missing attributes""""""
