...
@@ -245,7 +245,7 @@ def test_given_no_state_when_read_then_use_authorizations_endpoint(self, http_mo
...
+            _events_request().with_created_gte(state_datetime).with_created_lte(_NOW).with_limit(100).with_types(_EVENT_TYPES).build(),
             ...
             .build(),
@@ -272,18 +267,13 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
@@ -292,7 +282,7 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
         http_mocker.get(
             _events_request()
...
+            .with_created_gte(state_datetime)
             ...
             .with_limit(100)
             .with_types(_EVENT_TYPES)
@@ -311,24 +301,19 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
