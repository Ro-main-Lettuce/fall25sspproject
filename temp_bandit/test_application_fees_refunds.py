@@ -222,17 +222,17 @@ def test_given_slice_range_when_read_then_perform_multiple_requests(self, http_m
...
+            _application_fees_request().with_created_gte(slice_datetime).with_created_lte(_NOW).with_limit(100).build(),
             ...
             .with_record(_an_application_fee().with_field(_REFUNDS_FIELD, _as_dict(_refunds_response().with_record(_a_refund()))))
             .build(),
@@ -256,7 +256,11 @@ def test_given_slice_range_and_refunds_pagination_when_read_then_do_not_slice_ch
...
+            .build(),
             ...
             .with_record(
                 _an_application_fee()
@@ -360,7 +364,7 @@ def test_given_no_state_when_read_then_use_application_fees_endpoint(self, http_
...
@@ -369,12 +373,7 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
@@ -385,18 +384,13 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
@@ -405,7 +399,7 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
         http_mocker.get(
             _events_request()
...
+            .with_created_gte(state_datetime)
             ...
             .with_limit(100)
             .with_types(_EVENT_TYPES)
@@ -424,24 +418,19 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
