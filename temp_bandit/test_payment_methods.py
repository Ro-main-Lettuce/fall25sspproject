@@ -246,7 +246,7 @@ def test_given_no_state_when_read_then_use_payment_methods_endpoint(self, http_m
...
@@ -255,12 +255,7 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
+            _events_request().with_created_gte(state_datetime).with_created_lte(_NOW).with_limit(100).with_types(_EVENT_TYPES).build(),
             ...
             .build(),
@@ -273,18 +268,13 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
@@ -293,7 +283,7 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
         http_mocker.get(
             _events_request()
...
+            .with_created_gte(state_datetime)
             ...
             .with_limit(100)
             .with_types(_EVENT_TYPES)
@@ -312,24 +302,19 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
