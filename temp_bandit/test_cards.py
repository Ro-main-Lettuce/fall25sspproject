...
@@ -189,6 +189,7 @@ def test_given_http_status_400_when_read_then_stream_did_not_run(self, http_mock
...
+    @HttpMocker()
     ...
     def test_given_http_status_401_when_read_then_config_error(self, http_mocker: HttpMocker) -> None:
         http_mocker.get(
@@ -245,7 +246,7 @@ def test_given_no_state_when_read_then_use_cards_endpoint(self, http_mocker: Htt
...
@@ -254,12 +255,7 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
@@ -270,18 +266,13 @@ def test_given_state_when_read_then_query_events_using_types_and_state_value_plu
...
@@ -290,7 +281,7 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
         http_mocker.get(
             _events_request()
...
+            .with_created_gte(state_datetime)
             ...
             .with_limit(100)
             .with_types(_EVENT_TYPES)
@@ -309,24 +300,19 @@ def test_given_state_and_pagination_when_read_then_return_records(self, http_moc
