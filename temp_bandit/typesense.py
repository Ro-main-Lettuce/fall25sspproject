...
+    """"""Enhanced state management for the Typesense search component.""""""
     ...
     # State variables
     search_query: str = """"
@@ -93,7 +92,6 @@ class TypesenseSearchState(rx.State):
...
@@ -112,7 +110,6 @@ def _reset_search_state(self):
         self.search_results = []
...
@@ -123,9 +120,18 @@ def _get_filter_sections(self) -> list[str]:
...
+        """"""Enhanced search with component-aware logic.""""""
         ...
         if not query.strip():
@@ -135,7 +141,7 @@ async def search_docs(self, query: str):
...
@@ -144,99 +150,108 @@ async def search_docs(self, query: str):
...
+
     def hide_results(self):
         """"""Hide search results.""""""
         self.show_results = False
@@ -248,7 +263,7 @@ def navigate_to_result(self, url: str):
...
@@ -259,21 +274,18 @@ def filter_pill(filter_name: str) -> rx.Component:
     return rx.box(
         rx.text(
             filter_name,
...
@@ -283,16 +295,13 @@ def suggestion_item(title: str, url: str, icon: str = ""book-open"") -> rx.Compone
         rx.hstack(
...
@@ -308,23 +317,33 @@ def suggestions_section() -> rx.Component:
                     rx.cond(
...
@@ -333,47 +352,44 @@ def suggestions_section() -> rx.Component:
...
@@ -383,17 +399,19 @@ def search_input() -> rx.Component:
         rx.el.button(
             ""Esc"",
...
@@ -404,28 +422,25 @@ def search_modal() -> rx.Component:
         rx.box(
             rx.box(
                 search_input(),
...
@@ -452,37 +467,36 @@ def search_trigger() -> rx.Component:
